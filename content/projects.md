...
<div class="project-grid">
  ...
  <div class="project-card">
    ...
    <p class="project-desc">A modern directory website template built with Nuxt 4. Includes payment integration, blog system, and responsive layout.</p>
  ...
  <div class="project-card">
    ...
    <p class="project-desc">AI intelligent weekly report generator. Helps you summarize your work and plan ahead with the power of artificial intelligence.</p>
    <div class="project-tags">
  ...
  <div class="project-card">
    ...
    <p class="project-desc">Explore the world of herbs. A comprehensive guide to medicinal plants, their benefits, and traditional uses.</p>
    <div class="project-tags">
      <span class="tag">Nuxt</span>
